...
import {person, car, book, computer, movie, student, phone, customer, product, order} from './interfaces'
import {trip, house, game, musicAlbum, restaurant, movieCharacter, teacher, library, conference, weatherForecast} from './types'
